...
def main() -> int:
    ...
    must(html, 'id="btn-weapons"', "index.html")
    must(html, 'id="wep-pop"', "index.html")
    must(html, 'id="wep-sel"', "index.html")
    must(html, "Tap <strong>WEAPONS</strong>", "index.html")
    forbid(html, 'id="tray-l"', "index.html")
    forbid(html, 'id="tray-r"', "index.html")
    ...
    must(css, ".wep-sel", "game.css")
    forbid(css, "tray-chev", "game.css")
    ...
    must(game, "const HP_MAX = 80", "game.js")
    ...
    must(game, 'name: "Dynamite", dmg: 87, blast: 87', "game.js")
    must(game, 'name: "Sap Bomb", dmg: 60, blast: 78', "game.js")
    must(game, 'name: "Lodge Mortar", dmg: 75, blast: 81', "game.js")
    must(game, 'name: "Pinecone Cluster", dmg: 24, blast: 42', "game.js")
    must(game, 'name: "Woodchip Mine", dmg: 78, blast: 63', "game.js")
    must(game, "function plantSnare(", "game.js")
    must(game, "function gravPull(", "game.js")
    must(game, "function openWepPop(", "game.js")
    must(game, "function closeWepPop(", "game.js")
    forbid(game, "function scanFairX(", "game.js")
    forbid(game, "function stampPad(", "game.js")
    forbid(game, "function sampleBank(", "game.js")
    must(game, 'name: "Corkscrew Rocket", dmg: 83, blast: 69', "game.js")
    must(game, 'name: "Lodge Chaingun", dmg: 21, blast: 18', "game.js")
    ...
    must(game, "const SD_FLOOR = 14", "game.js")
    must(game, "const SD_TURN = 16", "game.js")
    must(game, "const SD_RISE = 18", "game.js")
    must(game, "function mapSd(", "game.js")
    must(game, "WALK_MAX", "game.js")
    must(game, "walkLeft", "game.js")
    must(html, "Walk left", "index.html")
    must(html, "Needs internet — same Wi-Fi not required.", "index.html")
    forbid(game, "function fairPads(", "game.js")
    ...
    must(read("js/net.js"), "turn:turn.evan-brass.net", "js/net.js")
    must(read("js/net.js"), "same Wi-Fi not required", "js/net.js")
    ...
    must(game, "function syncWepSel(", "game.js")
